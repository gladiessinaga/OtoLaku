...
Route::prefix('admin')->middleware(['auth', 'admin'])->group(function() {
    ...
    Route::get('/admin/pengembalian-terlambat', [AdminPengembalianController::class, 'terlambat'])->name('admin.pengembalian.terlambat');
});
...
Route::post('/perjanjian/upload', [PerjanjianController::class, 'upload'])->name('perjanjian.upload');
...
Route::post('/admin/pengembalian/tandai-terlambat/{id}', [AdminPengembalianController::class, 'tandaiTerlambat'])
    ->name('admin.tandaiTerlambat');

Route::get('/admin/pengembalian-terlambat', [AdminPengembalianController::class, 'daftarTerlambat'])
    ->name('admin.pengembalianTerlambat');

Route::get('/admin/pengembalian-terlambat', [AdminPengembalianController::class, 'terlambat'])
    ->name('admin.pengembalian-terlambat');

Route::delete('/admin/pemesanan/{id}/hapus', [PemesananController::class, 'hapus'])->name('admin.pemesanan.hapus');

Route::middleware(['auth', 'check.blocked'])->group(function () {
    Route::get('/dashboard', [DashboardController::class, 'index'])->name('dashboard');
    // dan semua route yang ingin kamu lindungi
});

Route::post('/admin/users/{id}/toggle-block', [DashboardController::class, 'toggleBlock'])->name('admin.users.toggleBlock');
...
Route::middleware(['auth', 'not_blocked'])->group(function () {
    Route::get('/dashboard', [DashboardController::class, 'index'])->name('dashboard');
    // atau semua route yang hanya untuk user aktif
});
