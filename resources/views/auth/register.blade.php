<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" id="registerForm" onsubmit="return validateRegisterForm()">
        ...
        <div class="mb-4">
            ...
            <x-text-input id="name" class="block mt-1 w-full focus:ring-2 focus:ring-[#3b465a] focus:outline-none" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
        ...
        <div class="mb-4">
            ...
            <x-text-input id="no_hp" class="block mt-1 w-full focus:ring-2 focus:ring-[#3b465a] focus:outline-none"
        ...
        <div class="mb-4">
            ...
            <x-text-input id="email" class="block mt-1 w-full focus:ring-2 focus:ring-[#3b465a] focus:outline-none" type="email" name="email" :value="old('email')" required autocomplete="username" aria-describedby="email-error" />
        ...
        <div class="mb-4 relative">
            ...
            <x-text-input id="password" class="block mt-1 w-full pr-10 focus:ring-2 focus:ring-[#3b465a] focus:outline-none" type="password" name="password" required autocomplete="new-password" aria-describedby="password-error" />
        ...
        <div class="mb-4 relative">
            ...
            <x-text-input id="password_confirmation" class="block mt-1 w-full pr-10 focus:ring-2 focus:ring-[#3b465a] focus:outline-none" type="password" name="password_confirmation" required autocomplete="new-password" aria-describedby="confirm-password-error" />
...
<div class="mb-4">
    <label for="terms" class="inline-flex items-center cursor-pointer select-none">
        ...
        <span class="ms-2 text-sm text-gray-600 dark:text-gray-400">
            Saya setuju dengan 
            <button type="button" onclick="openTermsModal()" class="underline text-[#3b465a] hover:text-[#3b465a] focus:outline-none focus:ring-2 focus:ring-[#3b465a] rounded">
    ...
    <p class="text-red-600 text-sm mt-1 hidden" id="terms-error">Anda harus menyetujui syarat dan ketentuan.</p>
        ...
        <div class="flex items-center justify-between">
            <a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#3b465a] dark:focus:ring-offset-gray-800" href="{{ route('login') }}">
                {{ __('Sudah terdaftar?') }}
            </a>

            <button type="submit" id="submitBtn" class="inline-flex items-center px-4 py-2 bg-[#46556D] hover:bg-[#3b465a] border border-transparent rounded-md font-semibold text-white hover:bg-[#3b465a] focus:outline-none focus:ring-2 focus:ring-[#3b465a] focus:ring-offset-2">
                {{ __('Register') }}
            </button>
        </div>
    </form>
...
<div id="termsModal" class="fixed inset-0 z-50 hidden overflow-y-auto bg-gray-900 bg-opacity-50 flex items-center justify-center">
    <div class="bg-white dark:bg-gray-800 rounded-lg p-6 w-11/12 max-w-2xl shadow-lg relative">
        <h2 class="text-xl font-semibold text-[#3b465a] dark:text-[#3b465a] mb-4">Syarat dan Ketentuan</h2>
        ...
        <div class="flex justify-end mt-4">
            <button onclick="closeTermsModal()" class="px-4 py-2 bg-[#3b465a] text-white rounded hover:bg-[#3b465a] focus:outline-none focus:ring-2 focus:ring-[#3b465a]">Tutup</button>
        </div>
    </div>
</div>
