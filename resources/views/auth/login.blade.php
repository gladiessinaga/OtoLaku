...
<div class="mb-4 relative">
    ...
    <input id="password"
           ...
           class="block mt-1 w-full pr-10 focus:ring-2 focus:ring-myprimary-500 focus:outline-none border-gray-300 rounded-md shadow-sm" />
    ...
    <button type="button" id="togglePassword"
        ...
        <div class="flex items-center justify-end">
            ...
            <button type="submit" 
                    id="submitBtn"
                    class="relative inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-white hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-50"
                    >
