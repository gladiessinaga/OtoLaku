<nav x-data="{ open: false }" class="bg-grey dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button 
                                ...
                                text-primary dark:text-primary bg-white dark:bg-gray-800 hover:text-primary dark:hover:text-primary
    ...
    <div class="flex flex-col sm:flex-row gap-2 sm:items-center">
        <a href="{{ route('login') }}"
           class="px-4 py-2 border border-myprimary-500 text-myprimary rounded-md text-center hover:bg-myprimary-200 transition w-full sm:w-auto">
            {{ __('Login') }}
        </a>
        <a href="{{ route('register') }}"
           class="px-4 py-2 bg-myprimary text-white rounded-md text-center hover:bg-myprimary transition w-full sm:w-auto">
            {{ __('Register') }}
        </a>
    </div>
@endguest
