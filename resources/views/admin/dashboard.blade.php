            ...
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
                    <a href="{{ route('admin.pemesanan.index') }}" 
                       class="flex items-center justify-center bg-[#46556D] hover:bg-[#7c8ba3] text-white font-medium py-3 px-4 rounded shadow transition text-center">
                        Pesanan Masuk
                    </a>
                    ...
                    <a href="{{ route('admin.verifikasi-pengembalian') }}"
                        ...
                        {{-- <a href="{{ route('admin.pengembalian-terlambat') }}"
   class="flex items-center justify-center bg-[#46556D] hover:bg-[#7c8ba3] text-white font-medium py-3 px-4 rounded shadow transition text-center">
            ...
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 space-y-4">
                <div class="flex justify-between items-center">
                    ...
                    <a href="{{ route('admin.mobil.create') }}" 
                       class="bg-[#46556D] hover:bg-[#7c8ba3] text-white px-4 py-2 rounded shadow transition">
                        + Tambah Mobil
                    </a>
                </div>
